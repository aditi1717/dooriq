...
import { settleUserReferralSafely, settleDeliveryReferralSafely } from '../../../../core/referrals/referral.service.js';
...
export async function completeDelivery(orderId, deliveryPartnerId, body = {}) {
  ...
  // The rider side of the same rule: their referrer is paid once this rider has
  // completed enough deliveries. No-op unless this rider was referred and is
  // still short of the threshold.
  await settleDeliveryReferralSafely(deliveryPartnerId, order._id);
