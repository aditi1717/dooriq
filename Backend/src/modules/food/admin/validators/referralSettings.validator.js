...
const schema = z.object({
    ...
    referredRewardUser: z.number().min(0).optional(),
    ...
    deliveryQualifyingDeliveries: z.number().int().min(0).max(1000).optional(),
...
export const validateReferralSettingsUpsertDto = (body) => {
    const normalized = {
        ...
        referredRewardUser: body?.referredRewardUser !== undefined ? Number(body.referredRewardUser) : undefined,
        ...
        deliveryQualifyingDeliveries: body?.deliveryQualifyingDeliveries !== undefined ? Number(body.deliveryQualifyingDeliveries) : undefined,
