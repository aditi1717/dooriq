...
async function run() {
    try {
        ...
        const restaurant = await FoodRestaurant.create({
            ...
            accountType: 'Saving',
            profileImage: 'https://i.ibb.co/5GzXz7r/Dooriq-Brand-Image.png',
            panImage: 'https://i.ibb.co/5GzXz7r/Dooriq-Brand-Image.png',
            fssaiImage: 'https://i.ibb.co/5GzXz7r/Dooriq-Brand-Image.png',
