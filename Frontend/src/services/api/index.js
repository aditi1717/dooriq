...
export const adminAPI = {
  ...
  updateCustomerWallet: (id, body = {}) =>
    apiClient.patch(`/food/admin/customers/${String(id)}/wallet`, body ?? {}, {
      contextModule: "admin",
    }),
  ...
  getPublicReferralSettings: () =>
    apiClient.get("/food/admin/referral-settings/public"),
...
export const restaurantAPI = {
  ...
  getPublicOffers: (params = {}) => apiClient.get("/food/restaurant/offers", { params, contextModule: "user" }),
  ...
  getCouponsByItemIdPublic: (restaurantId, _itemId, subtotal) =>
    apiClient.get("/food/restaurant/offers", { params: { restaurantId, subtotal }, contextModule: "user" }).then((res) => {
