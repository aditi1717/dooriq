...
// Demo products for /product/:id. Veg only: the platform serves an Indian
// audience, and this page is reachable by URL even though nothing links to
// it. Non-veg entries (beef, pork, chicken, seafood, egg) were removed; a
// removed id falls through to the not-found state below.
const productsData = {
  // Featured Dishes
